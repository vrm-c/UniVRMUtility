...
{
    public class RokuroCameraViewer : MonoBehaviour
    {
        [SerializeField]
        ...
        private IEnumerator MouseDragOperationCoroutine(int buttonIndex, Action<Vector2> dragOperation)
        {
            ...
            while (true)
            {
                ...
                while (Input.GetMouseButton(buttonIndex))
                {
                    ...
                    {
                        // The mouse pointer is on the panel, does nothing for camera movement
                    }
                    else if (_sliderAdjust == true)
                    {
                        // The mouse pointer is adjusting an expression, does nothing for camera movement
                    }
                    else
                    {
