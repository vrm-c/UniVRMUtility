...
namespace UniVRMUtility.SimpleViewer
{
    public class VRMRuntimeLoaderNet4 : MonoBehaviour
    {
        ...
        UniVRM10.VRMFirstPerson m_firstPerson;

        UniVRM10.VRMBlendShapeProxy m_blendShape;
        ...
        void SetupTarget()
        {
            if (m_target != null)
            {
                ...
                m_blendShape = m_target.GetComponent<UniVRM10.VRMBlendShapeProxy>();

                m_firstPerson = m_target.GetComponent<UniVRM10.VRMFirstPerson>();
